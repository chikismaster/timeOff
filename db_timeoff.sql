...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-01-2020 a las 19:09:23
...
CREATE TABLE `ventas` (
  ...
  `IdVendedor` int(10) UNSIGNED NOT NULL,
  `NumeroSerie` int(10) UNSIGNED ZEROFILL NOT NULL,
...
(56, NULL, 2, 0000008000, '2020-01-17', 9999, '1');
...
--
ALTER TABLE `ventas`
  MODIFY `IdVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
